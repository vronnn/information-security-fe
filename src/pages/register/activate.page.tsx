...
export default function ActivatePage() {
  ...
  const onSubmit = (data: activationAccForm) => {
        ...
        <div className='w-full'>
          ...
          <FormProvider {...methods}>
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className='flex flex-col items-center justify-evenly w-10/12 gap-6 mx-auto'>
                ...
                <div className='basis-1/2 order-1'>
                  <div className='max-w-xs h-full flex items-center max-h-60 overflow-hidden'>
                    <Image
