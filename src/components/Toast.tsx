  ...
  return (
    <div>
      <Toaster
        ...
        position='top-center'
        toastOptions={{
          className: 'font-medium rounded-lg font-primary',
        }}
      >
        {(t) => (
          <ToastBar toast={t}>
            {({ icon, message }) => (
              <>
                ...
                {t.type !== 'loading' && (
                  <button
                    className='rounded-full p-1 ring-primary-400 transition hover:bg-base-light focus:outline-none focus-visible:ring'
